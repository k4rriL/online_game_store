...
#function for displaying correct information about
#wanted game and creating the correct values for
#the payment service
def game_info(request):
    context = {}
    #Test game
    game = get_object_or_404(Game, id=1234234456)
    context["game"] = game
    #Test user
...
#function for handling successful payment
...
#Function for calculating hash value from string
